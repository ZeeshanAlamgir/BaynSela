...
class UserListDataTable extends DataTable
{
    ...
    $colArray = [
        ...
        Column::make('full_name')->name('users.first_name')->searchable(true)->orderable(false)->title('User Name'),
        Column::make('is_admin')->searchable(false)->orderable(false)->title('Role'),
        ...
        Column::make('company_name')->orderable(false)->searchable(true)->title('Company Name'),
