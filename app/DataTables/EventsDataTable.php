...
class EventsDataTable extends DataTable
{
    ...
    public function dataTable(QueryBuilder $query)
    {
        ...
        return (new EloquentDataTable($query))
            ...
            ->editColumn('title', function ($row) {
                return $row->fieldSingleValue('title', 'en')->value;
            })
            ...
            ->setRowId('id')
            ->rawColumns(array_merge($columns, ['actions', 'check', 'title', 'detail']));
    }


    public function query(Event $model): QueryBuilder
    {
        return $model->newQuery()->where('service_id', $this->id)->orderBy('created_at','desc');
    }
    ...
    protected function getColumns(): array
    {
        ...
        $colArray = [
            ...
            Column::make('title')->searchable(true)->orderable(false)->title('Title'),
            // Column::make('detail')->searchable(false)->title('Detail'),
