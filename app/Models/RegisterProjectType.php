...
class RegisterProjectType extends Model
{
    use HasFactory,SoftDeletes;
    protected $table = 'register_project_types';
    protected $fillable = ['project_type_id','user_id'];

    public function type()
    {
        return $this->hasMany(Translations::class,'project_type_id','transable_id')->get();
    }
