...
class ReviewSectionSeeder extends Seeder
{
    /**
    ...
    public function run()
    {
        $review = (new Review())->create([
            // 'id'    => 1,
            // 'about_section_id'=>1,
            'image'=>"review_section_default.jpeg"
        ]);
        ...
        $data = [
            ...
            [
                ...
                "value" => "General manager for Saudi Arabia, Jordan & Yemen",
                "locale" => "en",
            ],

            [
                "field" => "profile_designation",
                "value" =>  "مدير عام للسعوديةالاردن واليمن",
                "locale" => "ar",
            ],
