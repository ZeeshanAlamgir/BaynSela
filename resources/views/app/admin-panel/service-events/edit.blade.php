...
@section('seo-breadcrumb')
    {{ Breadcrumbs::view('breadcrumbs::json-ld', 'services.events.edit', decryptParams($serviceId), decryptParams($eventId)) }}
@endsection
        ...
        <div class="row breadcrumbs-top">
            <div class="col-12">
                ...
                <div class="breadcrumb-wrapper">
                    {{ Breadcrumbs::render('services.events.edit', decryptParams($serviceId), decryptParams($eventId)) }}
                </div>
            </div>
        </div>
    </div>
...
@section('content')
    ...
    <div class="card">
        <form action="{{ route('services.events.update.new', ['serviceId' => $serviceId, 'id' => $eventId]) }}" method="POST" enctype="multipart/form-data" id="service_event_form">
            ...
            <div class="card-body">
                ...
                {{ view('app.admin-panel.service-events.form-fields', ['service' => $service, 'event' => $event, 'maps_array' => $maps_array, 'image_map_loads' => $image_map_loads]) }}
...
@section('custom-js')
    ...
    <script>
        ...
        $(document).on('click', '.remove_old_number', function(){
            $(this).parent().parent().remove();
        });

        $(document).on('click', '.remove_old_imagemap', function(){
            $(this).parent().parent().remove();
        });
        ...
        $(document).on('click', '.u_e_remove_partnership_item', function(){
            $(this).parent().parent().remove();
        });
        ...
        //             return;
        //         }
        //         toastr.error("About Eng is Required.");
        //     }
