...
@section('seo-breadcrumb')
    {{ Breadcrumbs::view('breadcrumbs::json-ld', 'services.create') }}
@endsection
...
@section('breadcrumbs')
    <div class="content-header-left col-md-9 col-12 mb-2">
        <div class="row breadcrumbs-top">
            <div class="col-12">
                <h2 class="content-header-title float-start mb-0">Create Service</h2>
...
@section('content')
    ...
    <div class="card">
        <form action="{{ route('services.store.new') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="card-body">
                ...
                {{ view('app.admin-panel.new-services.form-fields') }}
