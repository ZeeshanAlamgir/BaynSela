...
<head>
    ...
    {{-- <link rel="stylesheet" type="text/css" href="{{ asset('app-assets') }}/css/plugins/toastr/toastr.css"> --}}
...
<body class="vertical-layout vertical-menu-modern  navbar-floating footer-static  " data-open="click"
    ...
    <script src="{{ asset('app-assets') }}/js/scripts/toastr/toastr.min.js"></script>
    {{-- <script src="{{ asset('app-assets') }}/vendors/datatables/buttons.server-side.js"></script> --}}
    <script src="{{ asset('app-assets') }}/js/scripts/forms/form-select2.min.js"></script>
    {{-- <script src="{{ asset('app-assets') }}/js/scripts/repeater/vendors.min.js"></script> --}}
