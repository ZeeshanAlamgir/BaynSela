...
@section('title')
{{ __('lang.commons.update_profile') }}
@endsection
@section('content')
...
<section class="edit_section">
        ...
        <div id="form_1" data-fetch-key="data-v-79e40af6:0" class="register-page" data-v-79e40af6>
            <div class="margin-content p-0" data-v-79e40af6>
                <div data-v-79e40af6>
                    <div class="step-1 step-grid-layout" data-v-ad4774d4 data-v-79e40af6>
                        <div class="user-data-section" data-v-ad4774d4>
                            ...
                            <h1 class="profile_heading">Edit Profile</h1>
                        </div>
                        <div class="dec mb-5 pb-3">
                            <p>You can update your information below. Once finished, please click done and the information will be updated.</p>
                        </div>
                                ...
                                <div data-v-ad4774d4="" class="grid-inputs">
                                    <div data-v-ad4774d4="" class="input-group">
                                        <div data-v-ad4774d4="" class="input-wrapper">
                                            <input data-v-ad4774d4="" name="first_name" id="first_name" type="text" placeholder="First Name" class="" value="{{$user ? $user['first_name'] : Null }}" required>
                                            <label data-v-ad4774d4="" for="first_name" class="label-name">
                                                <span data-v-ad4774d4="" class="content-name">First Name</span>
                                            </label>
                                        </div>
                                        <span data-v-ad4774d4="" class="error d-none first_name">The first name field is required </span>
                                    </div>
                                    <div data-v-ad4774d4="" class="input-group">
                                        <div data-v-ad4774d4="" class="input-wrapper"><input data-v-ad4774d4="" id="last_name" name="last_name" type="text" placeholder="Last Name" class="" value="{{ $user ? $user['last_name'] : Null }}" required><label data-v-ad4774d4="" for="last_name" class="label-name"><span data-v-ad4774d4="" class="content-name">Last Name</span></label></div><span data-v-ad4774d4="" class="error d-none last_name">The last name field is required</span>
                                    </div>
                                    <div data-v-ad4774d4="" class="input-group">
                                        <div data-v-ad4774d4="" class="input-wrapper">
                                            <div data-v-ad4774d4="" class="vue-tel-input" id="phone_code">
                                                    <input class="w-100 form-control country_feild vti__input" placeholder="Phone number" id="" type="text" name="phone" value="{{$data ? $data['phone_code'] : 0}} {{$user ? $user['phone'] : 0}}" disabled readonly />
                                                    <input class="w-100 form-control country_feild vti__input" placeholder="Phone Code" id="phone_no_code" type="hidden" name="phone_no_code" />

                                                    <!-- </form> -->
                                            </div><span data-v-ad4774d4="" class="error d-none phone">The phone field  field is required</span>
                                            <!---->
                                        </div>
                                    </div>
                                    <div data-v-ad4774d4="" class="input-group">
                                        <div data-v-ad4774d4="" class="input-wrapper"><input data-v-ad4774d4="" id="email" name="email" type="email" placeholder="Email" class="" value="{{ $user ? $user['email'] : Null }}" disabled readonly><label data-v-ad4774d4="" for="email" class="label-name"><span data-v-ad4774d4="" class="content-name">Email</span></label></div><span data-v-ad4774d4="" class="error d-none email">The email field is required</span>
                                    </div>
                                </div>

                                <h5 class="mt-5 pb-2">Company</h5>
                                <div data-v-ad4774d4="" class="grid-inputs">
                                    <div data-v-ad4774d4="" class="input-group input-margin">
                                        <div data-v-ad4774d4="" class="input-wrapper"><input data-v-ad4774d4="" id="company_name" name="company_name" type="text" placeholder="Company Name" class="" value="{{ $user ? $user['company_name'] : Null }}"><label data-v-ad4774d4="" for="company_name" class="label-name"><span data-v-ad4774d4="" class="content-name">Company Name</span></label></div><span data-v-ad4774d4="" class="error d-none company_name">The Company Name field is required</span>
                                    </div>

                                    <div data-v-ad4774d4="" class="input-group input-margin">
                                        <div data-v-ad4774d4="" class="input-wrapper"><input data-v-ad4774d4="" id="country" name="country" type="text" placeholder="Country" class="" value="{{ $user ? $user['country'] : Null }}"><label data-v-ad4774d4="" for="country" class="label-name" ><span data-v-ad4774d4="" class="content-name">Country</span></label></div><span data-v-ad4774d4="" class="error d-none country">The Country field is required</span>
                                    </div>

                                    <div data-v-ad4774d4="" class="input-group input-margin">
                                        <div data-v-ad4774d4="" class="input-wrapper"><input data-v-ad4774d4="" id="city" name="city" type="text" placeholder="City" class="" value="{{ $user ? $user['city'] : Null }}"><label data-v-ad4774d4="" for="city" class="label-name" ><span data-v-ad4774d4="" class="content-name">City</span></label></div><span data-v-ad4774d4="" class="error d-none city">The City field is required</span>
                                    </div>

                                    <div data-v-ad4774d4="" class="input-group input-margin">
                                        <div data-v-ad4774d4="" class="input-wrapper"><input data-v-ad4774d4="" id="industry" name="industry" type="text" placeholder="Industry" class="" value="{{ $user ? $user['industry'] : Null }}"><label data-v-ad4774d4="" for="industry" class="label-name" ><span data-v-ad4774d4="" class="content-name">Industry</span></label></div><span data-v-ad4774d4="" class="error d-none industry">The Industry field is required</span>
                                    </div>

                                    <div data-v-ad4774d4="" class="input-group input-margin">
                                        <div data-v-ad4774d4="" class="input-wrapper"><input data-v-ad4774d4="" id="company_size" name="company_size" type="number" placeholder="Company Size" class="" value="{{ $user ? $user['company_size'] : Null }}"><label data-v-ad4774d4="" for="company_size" class="label-name" ><span data-v-ad4774d4="" class="content-name">Company Size</span></label></div><span data-v-ad4774d4="" class="error d-none company_size">The Company Size field is required</span>
                                    </div>

                                    <div data-v-ad4774d4="" class="input-group input-margin">
                                        <div data-v-ad4774d4="" class="input-wrapper"><input data-v-ad4774d4="" id="annual_marketing_budget" name="annual_marketing_budget" type="text" placeholder="Annual Marketing Budget" class="" value="{{ $user ? $user['annual_marketing_budget'] : Null }}"><label data-v-ad4774d4="" for="annual_budget" class="label-name"><span data-v-ad4774d4="" class="content-name">Annual Marketing Budget</span></label></div><span data-v-ad4774d4="" class="error d-none annual_budget">The Annual Budget field is required</span>
                                    </div>

                                </div>

                                <h3 class="mt-5 pb-2">Interests</h3>
                                <h6>Project Type</h6>
                                <div data-v-ad4774d4="" class="grid-inputs d-flex">
                                    <div data-v-b15cf6d4="" class="user-data-section">
                                        <div data-v-b15cf6d4="" class="project-type-section">
                                            <div data-v-1ab7e22a="" data-v-b15cf6d4="" class="project-type">
                                                <div data-v-1ab7e22a="" class="selected-types mt-0"><span data-v-1ab7e22a="" id="count" class="count"></span><span data-v-1ab7e22a=""><span class="toggle_class_zero text-danger">{{ count($data['user_types_id']) }}</span>/5</span><span data-v-1ab7e22a="">selected</span></div>
                                                <div data-v-1ab7e22a="" class="row">
                                                                    ...
                                                                    <div data-v-7860d73a="" class="checkbox-wrapper">
                                                                        <div data-v-7860d73a="" class="checkboxex">
                                                                            <div data-v-7860d73a="" class="input-group" >
                                                                                <div data-v-7860d73a="" class="checkbox">
                                                                                    <label data-v-7860d73a="" for="p_type_{{ $type['project_type_id'] }}" class="pl-3">
                                                                                    <input data-v-7860d73a="" id="p_type_{{ $type['project_type_id'] }}" class="project_type_check_input" type="checkbox" name="project_type[]" value="{{ $type['project_type_id'] }}" {{ in_array($type['project_type_id'],$data['user_types_id']) ? "checked" : '' }} >
                                                                                    {{-- <span data-v-7860d73a="" class="check-mark"></span> --}}
                                                                                        <div data-v-7860d73a="" class="checkbox-text">
                                                                                            <span data-v-7860d73a="" class="p_type_span {{ in_array($type['project_type_id'],$data['user_types_id']) ? "text-danger" : '' }}">{{ $type['value']['value'] }}</span>
                                                                                        </div>
                                                                                    </label>
                                                                                </div>
                                                                            </div>
                                ...
                                <div data-v-ad4774d4="" class="grid-inputs">
                                    <div data-v-b15cf6d4="" class="user-data-section">
                                        <div data-v-b15cf6d4="" class="project-type-section">
                                            <div data-v-1ab7e22a="" data-v-b15cf6d4="" class="project-duration">
                                                <div data-v-1ab7e22a="" class="types">
                                                    <div class="row">
                                                    ...
                                                    <div class="col-md-6">
                                                        <div data-v-7860d73a="" class="checkbox-wrapper">
                                                            <div data-v-7860d73a="" class="checkboxex">
                                                                <div data-v-7860d73a="" class="input-group" >
                                                                    <div data-v-7860d73a="" class="checkbox">
                                                                        <label data-v-7860d73a="" for="{{ $duration['project_duration_id'] }}">
                                                                        <input data-v-7860d73a="" id="{{ $duration['project_duration_id'] }}" type="checkbox" name="project_duration[]" value="{{ $duration['project_duration_id'] }}" {{ in_array($duration['project_duration_id'],$data['user_duration_id']) ? "checked" : '' }} >
                                                                        <span data-v-7860d73a="" class="check-mark"></span>
                                                                            <div data-v-7860d73a="" class="checkbox-text"><span data-v-7860d73a="">{{ $duration['value']['value'] }}</span></div>
                                                                        </label>
                                                                    </div>
                                                                </div>
                                                            </div>
        ...
        <div class="col-md-5 text-right don_btn_col">

            <div data-v-ad4774d4="" class="">
                <button id="submit" data-v-ad4774d4="" type="submit" class="secondary update_btn profile_update" data-id ="{{$user['id']}}">Save Changes</button>
            </div>
...
<script>
        @isset($data['project_types'])
            @foreach ($data['project_types'] as $type)
                $(document).on('click','#type-{{$type["project_type_id"]}}',function(){
                    $("#item-{{$type['project_type_id']}}").toggleClass('text_clr');
                });
            @endforeach
        @endisset
</script>
<script>
    ...
    $(document).on('submit','#updateRegisterForm',function(e){
        e.preventDefault();
        let id = $('.update_btn').data('id');
        let data = $(this).serialize();
        $.ajax({
            type: "POST",
            url: "{{url('update-user-profile')}}/"+id,
            data: data,
            dataType: "json",
...
<script>
    ...
    $(document).ready(function(){
        let user_phone_code = "{{$user->phone_code}}";
        // alert(user_phone_code);
