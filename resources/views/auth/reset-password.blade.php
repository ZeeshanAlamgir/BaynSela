...
<div class="auth-container">
    <div class="margin-content">
        ...
        <div id="reset-password-div" data-v-31f0712a="" class="forgot-password-page" >
            <div data-v-31f0712a="" class="auth-content">
                @isset($data)
                    <h1 data-v-31f0712a="">{{ __('lang.commons.create_new_password') }}!</h1>
                    <p data-v-31f0712a="">{{ __('lang.commons.create_new_password_desc') }}.</p><span data-v-31f0712a="">
                        <form data-v-31f0712a="" novalidate="novalidate" class="form" id="reset-password-form">
                            @csrf
                            <div data-v-31f0712a="" class="input-group input-margin">
                                <div data-v-31f0712a="" class="input-wrapper">
                                    <input data-v-31f0712a="" name="new_password" id="new_password" type="password" placeholder="{{ __('lang.commons.new_password') }}" class="">
                                    <label data-v-31f0712a="" for="new_password" class="label-name">
                                        <span data-v-31f0712a="" class="content-name">{{ __('lang.commons.new_password') }}</span>
                                    </label>
                                </div>
                                <span data-v-21317946="" class="error new_password d-none w-100">{{ __('lang.validations.required.new_password') }}</span>
                            </div>

                            <div data-v-31f0712a="" class="input-group input-margin">
                                <div data-v-31f0712a="" class="input-wrapper">
                                    <input data-v-31f0712a="" name="repeat_password" id="repeat_password" type="password" placeholder="{{ __('lang.commons.repeat_password') }}" class="">
                                    <label data-v-31f0712a="" for="repeat_password" class="label-name">
                                        <span data-v-31f0712a="" class="content-name">{{ __('lang.commons.repeat_password') }}</span>
                                    </label>
                                </div>
                                <span data-v-21317946="" class="error repeat_password d-none w-100">{{ __('lang.validations.required.repeat_password') }}</span>
                                <span data-v-21317946="" class="error repeat_password_invalid d-none w-100">{{ __('lang.validations.valid.repeat_password') }}</span>
                            </div>
                            <input type="hidden" name="data" value="{{ $data }}">
                            <button data-v-31f0712a="" type="submit" class="primary">{{ __('lang.commons.reset_password') }}</button>
                        </form>
                    </span>

                @else

                    <h1 data-v-31f0712a="" class="text-danger">{{ __('lang.commons.session_expired') }}</h1>
        ...
        <div id="session-expired-div" data-v-31f0712a="" class="forgot-password-page d-none" >
            <div data-v-31f0712a="" class="auth-content">
                <h1 data-v-31f0712a="" id="" class="text-danger">{{ __('lang.commons.session_expired') }}</h1>
            </div>
        </div>

        <div id="high-five-div" data-v-31f0712a="" class="forgot-password-page d-none" >
            <div data-v-31f0712a="" class="auth-content">
                <h1 data-v-31f0712a="">{{ __('lang.commons.high_five') }}</h1>
                <p data-v-31f0712a="">{{ __('lang.commons.high_five_desc') }}</p><span data-v-31f0712a="">

                <button data-v-31f0712a="" id="login-btn" type="button" class="primary">{{ __('lang.commons.login') }}</button>
    ...
    $(document).on('submit', '#reset-password-form' , function(e){
        ...
        let repeat_password = $('#repeat_password').val();
            ...
            if (new_password == '' || new_password == null) {
                value = $('.new_password').removeClass('d-none');
                $('#new_password').css({
                    "border": "1px solid #ffdedc",
                    "color": "red",
                    "background-color": "#ffdedc"
            ...
            if (repeat_password == '' || repeat_password == null) {
                value = $('.repeat_password').removeClass('d-none');
                $('#repeat_password').css({
                    "border": "1px solid #ffdedc",
                    "color": "red",
                    "background-color": "#ffdedc"
                ...
                $('.repeat_password').addClass('d-none');
                $('#repeat_password').css({
                    "border": "1px solid #f3f3f3",
                    "color": "#000",
                    "background-color": "#f3f3f3"
            ...
            if (new_password != repeat_password) {
                value = $('.repeat_password_invalid').removeClass('d-none');
                $('#repeat_password').css({
                    "border": "1px solid #ffdedc",
                    "color": "red",
                    "background-color": "#ffdedc"
            ...
            if(!value){
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        ...
                        if (response['status']) {
                            $('#high-five-div').removeClass('d-none');
                            $('#reset-password-div').addClass('d-none');
                        }
                        else{
                            $('#session-expired-div').removeClass('d-none');
                            $('#reset-password-div').addClass('d-none');
                        }
                    }
                });
