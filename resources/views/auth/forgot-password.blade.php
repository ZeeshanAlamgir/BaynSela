...
@section('title')
{{ __('lang.commons.forgot_password') }}
@endsection
@section('content')
...
<div class="auth-container">
    <div class="margin-content">
        ...
        <div id="forgot_form" data-v-31f0712a="" class="forgot-password-page" >
            <div data-v-31f0712a="" class="auth-content">
                ...
                <p data-v-31f0712a="">{{ __('lang.commons.forgot_password_desc') }}.</p><span data-v-31f0712a="">
                    <form data-v-31f0712a="" novalidate="novalidate" class="form" id="send-email-form">
                        @csrf
                        <div data-v-31f0712a="" class="input-group input-margin">
                            <div data-v-31f0712a="" class="input-wrapper">
                                <input data-v-31f0712a="" name="email" id="email" type="email" placeholder="{{ __('lang.commons.email') }}" class="">
                                <label data-v-31f0712a="" for="email" class="label-name">
                                    <span data-v-31f0712a="" class="content-name">{{ __('lang.commons.email') }}</span>
                                </label>
                            </div>
                        ...
                        <button data-v-31f0712a="" type="submit" class="primary">{{ __('lang.commons.send_email') }}</button>
                    </form>
                </span>
            </div>
        </div>
        ...
        <div id="resend_email_div" data-v-31f0712a="" class="forgot-password-page d-none" >
            <div data-v-31f0712a="" class="auth-content">
                <h1 data-v-31f0712a="">{{ __('lang.commons.email_sent') }}</h1>
                <p data-v-31f0712a="">{{ __('lang.commons.email_sent_desc') }}</p><span data-v-31f0712a="">
                <button data-v-31f0712a="" id="resend_email_btn" type="button" class="primary">{{ __('lang.commons.resend_email') }}</button>
                </span>
            </div>
        </div>
...
<script>
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        ...
                        if (response['status']) {
                            ...
                            $("#resend_email_div").removeClass('d-none');
                        }
                        else{
    ...
    $(document).on('click', '#resend_email_btn', function(){
        $("#forgot_form").removeClass('d-none');
        $("#resend_email_div").addClass('d-none');
    });
